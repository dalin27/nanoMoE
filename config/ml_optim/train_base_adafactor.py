...
scale_parameter = False # Set to False to use the explicit learning_rate defined below
relative_step = False   # Set to False to use your custom warmup/decay schedule
warmup_init = False
